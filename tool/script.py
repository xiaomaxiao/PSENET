...
def default_evaluation_params():
    ...
    return {
            ...
            'DET_SAMPLE_NAME_2_ID':'gt_img_([0-9]+).txt',            
...
def validate_data(gtFilePath, submFilePath, evaluationParams):
    ...
    """
    print('load:',gtFilePath,submFilePath)
    print(evaluationParams['GT_SAMPLE_NAME_2_ID'])
...
def evaluate_method(gtFilePath, submFilePath, evaluationParams):
    ...
    def transcription_match(transGt,transDet,specialCharacters=r'!?.:,*"()·[]/\'',onlyRemoveFirstLastCharacterGT=True):
